...
class Renderer
{
    ...
    public:
        ...
        void drawShadowMap(Vec3 &p1, Vec3 &p2, Vec3 &p3, Vec3 &v1, Vec3 &v2, Vec3 &v3 ,Vec3 &uv1, Vec3 &uv2, Vec3 &uv3, unsigned char* data, int texW, int texH, float* shadowZBuffer, Model** shadowEBuffer, Model* model, int shadowMapWidth, int shadowMapHeight);
