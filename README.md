  ...
  The engine is in its beginning state, so it will take some time to be really useful. I intend to add things like physics support, shader support, sound support, Nanite, and so on.<br><br>
 ...
 ./test.bat<br>
  ...
  - Using MSYS2 install the necessary to compile the project using the command below: <br>
  ...
  - __> pacman -S mingw-w64-ucrt-x86_64-assimp<br><br>
  
  Then add the path C:\msys64\ucrt64\bin to your envoronment variables, if you installed MSYS2 on the root of the system.<br>
